...
export class ChatService {
  constructor(
    ...
    private readonly conversation: typeof Conversation,
    @InjectModel(ConversationParticipant)
    private readonly conversationParticipant: typeof ConversationParticipant,
  ...
  async leftConversation(
    ...
    const [, updated] = await this.conversationParticipant.update(
      { leftAt: new Date() },
      {
        where: {
